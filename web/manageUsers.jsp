...
<!--                        <nav class="hidden md:flex items-center space-x-6">
                            ...
                            <a href="manageUsers.jsp" class="text-sm font-medium text-blue-600">Manage Users</a>
            ...
            <main class="flex-1 overflow-y-auto p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">Manage User data</p>
                </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                <thead class="bg-gray-50 border-b border-gray-200">
                                    <tr>
                                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">User ID</th>
                                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">User Name</th>
                                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Email Address</th>
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <tr>
                                        <td class="px-6 py-4 text-sm text-gray-600"><%= u.getUserId() %></td>
                                        <td class="px-6 py-4 text-sm text-gray-600"><%= u.getUsername() %></td>
                                        <td class="px-6 py-4 text-sm text-gray-600"><%= u.getEmail() %></td>
                                        <td class="px-6 py-4">
                                            <div class="flex space-x-2">
        
                                               <form action="updateUser.jsp" method="post">
                                                    <input type="hidden" name="email" value="<%= u.getEmail() %>">
                                                    <button type="submit" class="px-4 py-2 bg-white text-blue-500 border-2 border-blue-500 text-xs rounded-lg hover:bg-blue-500 hover:text-white transition">Edit</button>
                                               </form>

                                               <form action="DeleteUserServlet" method="post">
                                                    <input type="hidden" name="userid" value="<%= u.getUserId() %>">
                                                    <button type="submit" class="px-4 py-2 bg-white text-red-500 border-2 border-red-500 text-xs rounded-lg hover:bg-red-500 hover:text-white transition">Delete</button>
                                               </form>
