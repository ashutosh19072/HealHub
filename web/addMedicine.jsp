...
<!--<html>
    <head>
        ...
        <title>Add medicine | HealHub</title>
    ...
    <body>
        ...
        <form action="" method="post">
            ...
            <label for="medicineName">Choose Medicine</label>
...
<body class="bg-gradient-to-br from-blue-50 to-green-50">
     ...
     <%
            ...
            List<Medicine> allMedicineName = MedicineDAO.getAllMedicineName();
            
            String pharmacy_id = (String)session.getAttribute("pharmacy_id");
...
<!--                            <a href="adminDashboard.jsp" class="text-sm font-medium text-gray-600 hover:text-blue-600 transition">Dashboard</a>
        ...
        <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
            ...
            <form action="AddMedicineServlet" method="post" class="mt-8 space-y-6">
                <div class="rounded-md shadow-sm">
                    <div class="relative mb-1">
                        <select name="medicine" required class="appearance-none rounded-md relative block w-full px-10 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-teal-500 focus:border-teal-500 focus:z-10 sm:text-sm" placeholder="Select Medicine">
                    <%
                        for(Medicine m : allMedicineName)
                        {
                    %>
                    ...
                    <% } %>
                        ...
                        <input id="quantity" name="quantity" type="number" required class="appearance-none rounded-md relative block w-full px-10 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-teal-500 focus:border-teal-500 focus:z-10 sm:text-sm" placeholder="Quantity in Stock">
                        <input type="hidden" name="userid" value="<%= u.getUserId() %>">
                        <input type="hidden" name="userpassword" value="<%= u.getUsername() %>">
                ...
                <button type="submit" class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors shadow-lg shadow-teal-100">
                    ...
                    <span id="submit-text">Add Stock</span>
                </button>
            </form>
