        ...
        <aside class="w-64 bg-white shadow-lg flex flex-col">
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="managePharmacy.jsp" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-blue-50 text-blue-600 font-medium">
...
<!--                        <nav class="hidden md:flex items-center space-x-6">
                            ...
                            <a href="managePharmacy.jsp" class="text-sm font-medium text-blue-600">Manage Pharmacies</a>
            ...
            <main class="flex-1 overflow-y-auto p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">Manage Pharmacy data </p>
                </div>
                
                <!-- Search Results Section -->
                <div class="mb-8">
                    <h2 class="text-xl font-bold text-gray-800 mb-4">Registered Pharmacies</h2>
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <%
                                    List<Pharmacy> approvedPharmacy = PharmacyDAO.getApprovedPharmacy(); 
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex space-x-2">
                                                <form action="CancelPharmacyApprovalServlet" method="post">
                                                    <input type="hidden" name="pid" value="<%= p.getPharmacyId()%>">
                                                    <button type="submit" class="px-4 py-2 bg-white text-orange-500 border-2 border-orange-500 text-xs rounded-lg hover:bg-orange-500 hover:text-white transition">Cancel Approval</button>
                                               </form>
                                            </div>
                                        </td>
                                    </tr>
